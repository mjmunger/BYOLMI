...
There are two installers in this repo, nsis-x86 and nsis-x64, which are nullsoft installers for the x86 and x64 architectures, respectively.

In order to customize these installers for your own use, you need to replace the "webservices\hosts\webservices" file with one generated by your primary tinc node (that you created above, right?)
